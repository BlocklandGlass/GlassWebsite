...
<html>
  ...
  <body>
    ...
    <p>
      ...
      with our users and others which may interact or interface with Blockland Glass,
      also known as Glass, located in Massachusetts, and our subsidiaries and affiliates, in association with the use of the Glass website, which includes blocklandglass.com, (the "Site") and its Services,
      which shall be defined below.
    </p>
    <h2>DESCRIPTION OF WEBSITE SERVICES OFFERED</h2>
    <p>
      The Site is an online discussion website a content and social platform which has the
      following description:
    </p>
    <p>
      Providing infrastructure for Blockland players to freely communicate and share content made both within and outside of Blockland.
    </p>
    <p>
    ...
    <p>
      ...
      and downloadable programs, are the sole property of Blockland Glass. At its discretion, Blockland Glass may offer
      ...
      revised Services unless otherwise stipulated. Blockland Glass does
      hereby reserve the right to cancel and cease offering any of the aforementioned
      Services and/or products. You, as the end user  and/or member,  acknowledge, accept and agree that Blockland Glass shall not be held liable for any such updates, modifications, revisions,
    ...
    <p>
      ...
      as such Blockland Glass shall not assume any responsibility or
    ...
    <p>
      ...
      individual that has been previously barred from receiving Glass's
      Services under the laws and statutes of the United States or other applicable
      jurisdiction.
    </p>
    <p>
      When you register,
      Glass may collect information such as your name,
      e-mail address, birth date, gender, mailing address, occupation, industry and
      personal interests. You can edit your
      account information at any time. Once you register with Glass and sign in to our Services, you are no longer anonymous to us.
    </p>
    <p>
    ...
    <p>
      ...
      information of a false, untrue, inaccurate or incomplete nature, Blockland Glass will have sufficient grounds and rights to suspend or terminate the member in
      violation of this aspect of the Agreement, and as such refuse any and all
      current or future use of Blockland Glass Services, or any portion
      thereof.
    </p>
    <p>
      It is Blockland Glass's
      ...
      access to the Glass website platform Services must
    ...
    <p>
      ...
      It shall be your responsibility to notify Blockland Glass immediately
      if you notice any unauthorized access or use of your account or password or any
      other breach of security. Blockland Glass shall not be held liable for
    ...
    <p>
      ...
      made available by way of the Glass Services, and as
      ...
      of any content posted, emailed, transmitted or otherwise made available by Glass.
    </p>
    <p>
      Furthermore,
      you herein agree not to make use of Blockland Glass's Services for the
      purpose of:
    </p>
    <ol type="a">
      <li>
      ...
      <li>
        causing
        harm to minors in any manner whatsoever;
      </li>
      <li>
        impersonating
        any individual or entity, including, but not limited to, any Glass officials, forum leaders, guides or hosts or falsely stating or otherwise
      ...
      <li>
        interfering
        with or disrupting any Blockland Glass Services, servers and/or networks
      ...
      <li>
        "stalking"
        or with the intent to otherwise harass another individual; and/or
      </li>
      <li>
        collecting
    ...
    <p>
      Blockland Glass herein reserves the right to pre-screen, refuse and/or delete any content
    ...
    <p>
      Blockland Glass herein reserves the right to access, preserve and/or disclose member account
    ...
    <ol type="a">
      ...
      <li>
        protecting
        the rights, property or the personal safety of Blockland Glass, its
        visitors, users and members, including the general public.
      </li>
    </ol>
    <p>
      Blockland Glass herein reserves the right to include the use of security components that may
      ...
      established by Blockland Glass or any other content providers
      supplying content services to Blockland Glass. You are hereby
    ...
    <p>
      ...
      acknowledge that by using blocklandglass.com to send electronic
    ...
    <p>
      Blockland Glass shall not lay claim to ownership of any content submitted by any visitor, member, or user, nor
      make such content available for inclusion on our website Services. Therefore,
      you hereby grant and allow for Blockland Glass the below listed
    ...
    <ol type="a">
      <li>  
        ...
        areas of Blockland Glass's sites, the license provided to permit to
        ...
        you are a member of Blockland Glass's sites, and shall terminate at
      ...
      <li>
        ...
        publicly accessible areas of Blockland Glass's sites, the license
        ...
        available so long as you are a member of Blockland Glass's sites and
      ...
      <li> 
        ...
        accessible areas of Blockland Glass's sites, the continuous, binding
    ...
    <p>
      Those areas which may be deemed "publicly accessible" areas of Blockland Glass's
    ...
    <p>
      Blockland Glass provides an area for our users and members to contribute feedback to our website. When
    ...
    <ol type="a">
      ...
      <li>  
        Glass shall not be liable or under any obligation to ensure or maintain
        confidentiality, expressed or implied, related to any Contributions;
      </li>
      <li>
        Glass shall be entitled to make use of and/or disclose any such Contributions in any
        such manner as they may see fit;
      </li>
      <li>
        the
        contributor's Contributions shall automatically become the sole property of Glass;
        and
      </li>
      <li> 
        Glass is under no obligation to either compensate or provide any form of
    ...
    <p>
      ...
      hold Blockland Glass, our subsidiaries, affiliates, agents, employees,
      ...
      Services, the use of  Glass Services or your connection with these Services, your violations of the Terms
      of Service and/or your violation of any such rights of another person.
    </p>
    <h2>COMMERCIAL REUSE OF SERVICES</h2>
    <p>
      The member or user herein
      agrees not to replicate, duplicate, copy, trade, sell, resell nor exploit for
      any commercial reason any part, use of, or access to Glass's
      sites.
    </p>
    <h2>USE AND STORAGE GENERAL PRACTICES</h2>
    <p>
      You herein acknowledge that Blockland Glass may set up any such practices
      ...
      content shall be retained by Blockland Glass, nor the maximum number
      ...
      allocated on Blockland Glass's servers on the member's behalf, and/or
      the maximum number of times and/or duration that any member may access our Services
      in a given period of time.  In addition, you also agree that Blockland Glass has absolutely no
      ...
      time. Furthermore, Blockland Glass shall reserve the right to modify,
      alter and/or update these general practices and limits at our discretion.
    </p>
    <p>
      Any messenger service, which may include any web-based versions, shall allow you
      and the individuals with whom you communicate with the ability to save your
      conversations in your account located on Blockland Glass's servers. In
      ...
      option to use and save conversations with you in their own personal account on blocklandglass.com.
      It is your agreement to this TOS which establishes your consent to allow Blockland Glass to store any and all communications on its servers.
    </p>
    <h2>MODIFICATIONS</h2>
    <p>
      Blockland Glass shall reserve the right at any time it may deem fit, to modify, alter and or
    ...
    <h2>TERMINATION</h2>
    <p>
      As a member of blocklandglass.com, you may cancel or terminate your
      account, associated email address and/or access to our Services by submitting a
      cancellation or termination request to admin@blocklandglass.com.
    </p>
    <p>
      As a member, you agree that Blockland Glass may, without any prior written
    ...
    <ol type="a">
      ...
      <li>
        the discontinuance, alteration and/or material modification to our Services, or any
        part thereof;
      </li>
      <li>
      ...
      <li>   
        the nonpayment of any associated fees that may be owed by you in connection with
        your blocklandglass.com account Services.
      </li>
    </ol>
    <p>
    ...
    <p>
      The termination of your account with blocklandglass.com shall include any
      and/or all of the following:
    </p>
    <ol type="a">
      <li>
        the
        removal of any access to all or part of the Services offered within blocklandglass.com;
      </li>
      <li>
        the
    ...
    <p>
      ...
      Moreover, you herein agree that Blockland Glass shall not be held
    ...
    <h2>LINKS</h2>
    <p>
      Either Blockland Glass or any third parties may provide links to other websites
      ...
      or resources. Furthermore, you acknowledge and agree that Blockland Glass shall not be responsible or liable, directly or indirectly, for any such damage
    ...
    <p>
      You do hereby acknowledge and agree that Blockland Glass's Services and any
      ...
      by applicable law or as authorized by Blockland Glass or such
      ...
      plagiaristic works which are based on Blockland Glass Services (e.g.
      Content or Software), in whole or part.
    </p>
    <p>
      Blockland Glass herein has granted you personal, non-transferable and non-exclusive rights
      ...
      other than through the interface which is provided by Blockland Glass for
    ...
    <ol type="a">
      <li>
        THE USE OF BLOCKLAND GLASS SERVICES AND SOFTWARE ARE AT THE SOLE RISK
        BY YOU. OUR SERVICES AND SOFTWARE SHALL BE PROVIDED ON AN "AS IS" AND/OR "AS
        AVAILABLE" BASIS. BLOCKLAND GLASS AND OUR SUBSIDIARIES, AFFILIATES,
      ...
      <li> 
        BLOCKLAND GLASS AND OUR SUBSIDIARIES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS MAKE
        NO SUCH WARRANTIES THAT (i) BLOCKLAND GLASS SERVICES OR SOFTWARE
        WILL MEET YOUR REQUIREMENTS; (ii) BLOCKLAND GLASS SERVICES OR
        SOFTWARE SHALL BE UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE; (iii) THAT SUCH
        RESULTS WHICH MAY BE OBTAINED FROM THE USE OF THE BLOCKLAND GLASS SERVICES
      ...
      <li> 
        ANY
        INFORMATION OR MATERIAL DOWNLOADED OR OTHERWISE OBTAINED BY WAY OF BLOCKLAND GLASS SERVICES OR SOFTWARE SHALL BE ACCESSED BY YOUR SOLE DISCRETION AND SOLE RISK,
      ...
      <li> 
        ...
        OBTAINED BY YOU FROM BLOCKLAND GLASS OR BY WAY OF OR FROM OUR SERVICES
        OR SOFTWARE SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED IN THE TOS.
      </li>
      <li>   
        A SMALL PERCENTAGE OF SOME USERS MAY EXPERIENCE SOME DEGREE OF EPILEPTIC SEIZURE
    ...
    <p>
      YOU EXPLICITLY
      ACKNOWLEDGE, UNDERSTAND AND AGREE THAT BLOCKLAND GLASS AND OUR SUBSIDIARIES,
    ...
    <h2>RELEASE</h2>
    <p>
      In the event you have a dispute, you agree to release Blockland Glass (and
    ...
    <p>
      Should you intend to create or to join any service, receive or request any such news,
      ...
      appropriate. Blockland Glass's content is provided primarily for
      informational purposes, and no content that shall be provided or included in
      our Services is intended for trading or investing purposes. Blockland Glass and our licensors shall not be responsible or liable for the accuracy,
    ...
    <h2>NOTICE</h2>
    <p>
      Blockland Glass may furnish you with notices, including those with regards to any changes to
    ...
    <p>
      You herein acknowledge, understand and agree that all of the Blockland Glass trademarks, copyright, trade name, service marks, and other Blockland Glass logos and any brand features, and/or product and service names are trademarks
      and as such, are and shall remain the property of Blockland Glass. You
      herein agree not to display and/or use in any manner the Blockland Glass logo or marks without obtaining Blockland Glass's prior written
      consent.
    </p>
    <h2>
    ...
    <p>
      Blockland Glass will always respect the intellectual property of others, and we ask that all of
      our users do the same. With regards to appropriate circumstances and at its
      sole discretion, Blockland Glass may disable and/or terminate the
    ...
    <p>
      The Blockland Glass Agent for notice of claims of copyright or other intellectual property
      infringement can be contacted as follows:
    </p>
    <p>
      Email:        admin@blocklandglass.com
    </p>
    <p>
        CLOSED CAPTIONING
    </p>
    <p>
      BE IT KNOWN, that Blockland Glass complies with all applicable Federal
    ...
    <p>
      ...
      between you and us with respect to Blockland Glass Services. You may
    ...
    <p>
      ...
      of the state of Massachusetts without regard to its conflict of
      law provisions and that any and all claims, causes of
      action and/or disputes, arising out of or relating to the TOS, or the
      relationship between you and Blockland Glass, shall be filed within
      the courts having jurisdiction within the County of Hampshire, Massachusetts or the U.S. District Court located in said state. You and Blockland Glass agree to submit to the jurisdiction of the courts as previously mentioned, and
    ...
    <p>
      Please
      report any and all violations of this TOS to Blockland Glass as
      follows:
    </p>
    <p>
      Email:        admin@blocklandglass.com
