...
<div class="maincontainer">
  ...
  ?>
	<ul class="addonnav tile">
		...
		?>
		<li><a class="addonnavmod" href="review">Review<?php if(sizeof(AddonManager::getUnapproved()) > 0) { echo " <span class=\"notice\">" . sizeof(AddonManager::getUnapproved()) . "</span>"; } ?></a></li>
